...
; (function ($, window, document, undefined) {
    ...
    var pluginName = "simpleCalendar",
        defaults = {
            ...
            days: ['sábado', 'domingo', 'segunda', 'terça', 'quarta', 'quinta', 'sexta'], //string of days starting from sunday
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            var calendar = $('<div class="calendar-mobile"></div>');
            var header = $('<header>' +
                '<h2 class="month"></h2>' +
                '<h4 class="year"></h4>' + 
                '<a class="btn btn-prev" href="#"><img src="https://img.icons8.com/ios/30/000000/long-arrow-left-filled.png"></a>' +
                '<a class="btn btn-next" href="#"><img src="https://img.icons8.com/ios/30/000000/long-arrow-right-filled.png"></a>' +
                '</header>');
        ...
        bindEvents: function () {
            ...
            $('.btn-prev').click(function (e) {
                ...
                plugin.buildCalendar(plugin.currentDate, $(plugin.element).find('.calendar-mobile'));
