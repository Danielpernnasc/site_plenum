...
<header> 
    ...
    <div  class="container" id="container_body_superior" >
                    ...
                    <div id="caixa-entrega" class="row">
                        <div class="col-md-5">
                            <div class="row">
                                ...
                                <div class=" col-sm-1" style="margin: 1% 1%; ">
                                    <button onclick="location.href='cartao.php'" class="radio-frete">
                                ...
                                <div class="endereco col-sm-5">
                                    
                                    <h5>CARTĀO DE CRÉDITO</h5>
                                </div>
        ...
        <div id="linha-total" class="row">
            ...
            <div class="campo-btn-comprar col-md-6">
                <button class="btn-mais-comprar">FINALIZAR COMPRA
                    <span>
