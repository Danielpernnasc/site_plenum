                    ...
                    <div class="col-md-12">
                        <div id="container_menu_plenum" class="container">
                            <div class= "row">
                                ...
                                <div id="subplenum" class="col-md-3" >
                                    <div class="submenu"><a href="implantes.php">Implantes</a></div>
                                    <div class="submenu"><a href=componentes.php">Componentes</a></div>
                                    <div class="submenu"><a href="transferentes.php">Transferentes</a></div>
                                    <div class="submenu"><a href="analogos.php">Análogos</a></div>
                                    <div class="submenu"><a href="acessorios.php">Acessórios</a></div>
                                    <div class="submenu"><a href="kits-cirurgicos.php">Kits Cirúgicos</a></div>
                                    <div class="submenu"><a href="biomateriais.php">Biomateriais</a></div>
                                    <div class="submenu"><a href="instrumentais.php">Instrumentais</a></div>
                                    <div class="submenu"><a href="start-plenum.php"> Start Plenum</a></div>
                                    <div class="submenu"><a href="instrucao-uso.php">Instruções de Uso</a></div>
                                </div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <button class="dropdown-btn">PRODUTOS</button>
                                            <div class="dropdown-mobile">
                                                <a href="implantes.php">Implantes</a>
                                                <a href="componentes.php">Componentes</a>
                                                <a href="transferentes.php">Transferentes</a>
                                                <a href="analogos.php">Análogos</a>
                                                <a href="acessorios.php">Acessórios</a>
                                                <a href="kits-cirurgicos.php">Kits Cirúgicos</a>
                                                <a href="biomateriais.php">Biomateriais</a>
                                                <a href="instrumentais.php">Instrumentais</a>
                                                <a href="start-plenum.php"> Start Plenum</a>
                                                <a href="instrucao-uso.php">Instruções de Uso</a>
                                            </div>
                                    </li>
                                    <li >
                                        <button class="dropdown-btn" >PESQUISA CIENTíFICO</button>
                                        <div class="dropdown-mobile">
