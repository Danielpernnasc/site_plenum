             ...
             <div class="linha-carousel-implantes row">
                  ...
                  <div id="carrossel_produtos-componentes" >
                                ...
                                <div class="linha-button-componentes row">
                                            <div class="col-md-12">
                                                <button class="componentes" onclick="window.location.href='componentes-short.php'">Ver todos os Componentes</button>
                                            </div>
                                        </div>
                            </div>
            ...
            <div class="col-xs-12 col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <button class="btn-selecionar">Selecionar Implantes</button>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="size-short col-md-3">
                        ...
                        <span>SH D4,0 x 6,00mm</span><br>
                        <input id="implantes-shorts" type="checkbox">
                        <span>SH D4,0 x 7,0mm</span><br>
                        <input id="implantes-shorts" type="checkbox">
                        <span>SH D4,5 x 5,0mm</span><br>
                    </div>
                    <div class="size-short col-md-3">
                        <input id="implantes-shorts" type="checkbox">
                        <span>SH D4,5 x 6,0mm</span><br>
                        <input id="implantes-shorts" type="checkbox">
                        <span>SH D4,5 x 7,0mm</span><br>
                        <input id="implantes-shorts" type="checkbox">
                        <span>SH D5,0 x 5,00mm</span><br>
                    </div>
                    <div class="size-short col-md-3">
                        <input id="implantes-shorts" type="checkbox">
                        <span>SH D5,0 x 6,0mm</span><br>
                        <input id="implantes-shorts" type="checkbox">
                        <span>SH D5,0 x 7,0mm</span><br>
                        <input id="implantes-shorts" type="checkbox">
                        <span>SH D6,0 x 5,0mm</span><br>
                    </div>
                    <div class=" size-short col-md-3">
                        <input id="implantes-shorts" type="checkbox">
                        <span>SH D6,0 x 6,00mm</span><br>
                        <input id="implantes-shorts" type="checkbox">
                        <span>SH D6,0 x 7,0mm</span><br>
